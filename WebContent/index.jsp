																								...
																								$(
																										...
																										.append(
																												"<tr>"
																														...
																														+ '</td>'
																														+ '<td>'
																														+ data.Pessoa[i].cidade
																														+ '</td>'
																														+ '<td><a href="javascript:void(0)" onclick="abrirDialog('
																														+ data.Pessoa[i].id
																														+ ',\''
																														+ data.Pessoa[i].nome
																														+ '\','
																														...
																														+ data.Pessoa[i].cidade
																														+ '\');">Editar</a></td>'
																														+ '<td><a href="Controle?cmd=excluir&id='
																														+ data.Pessoa[i].id
																														+ '">Excluir</a>'
																														+ '</td></tr>');
																							}
...
<body>
	...
	<div id="thedialog" title="Editar Usuario">
		<span class="ui-icon ui-icon-note"
			style="float: right; margin: 0 7px 50px 0;"></span>
		<form action="#" method="post">

			<input type="hidden" id="id" /> Nome :<input type="text" name="nome"
				id="n" /><br /> Idade :<input type="text" name="idade" id="i" /><br />
			Cidade :<br />
			<input type="text" name="cidade" id="c" /><br />
